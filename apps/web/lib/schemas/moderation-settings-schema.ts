...
export type ModerationSettingsFormData = z.infer<typeof moderationSettingsFormSchema>;

/**
 * Convert form data to API payload format
 */
export function convertModerationFormToPayload(data: ModerationSettingsFormData) {
 ...
 */
export function convertModerationPayloadToForm(project: any): ModerationSettingsFormData {
