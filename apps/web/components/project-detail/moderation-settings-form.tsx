    ...
    <div className="space-y-6">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          {/* Core Settings */}
          <CoreModerationSettings control={form.control} watch={form.watch} />
            ...
            <Card className="border-primary/20 bg-primary/5">
              ...
              <CardContent className="text-sm space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-2">
                  <li>
                    <strong>Profanity Detection:</strong> Blocks severe
                    profanity, flags mild profanity
                  </li>
                  <li>
                    <strong>Spam Detection:</strong> Checks for excessive URLs,
                    caps, special characters, promotional language
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Quality Scoring:</strong> Evaluates length, rating,
                    and OAuth verification
                  </li>
                </ul>
                <p className="text-muted-foreground pt-2">
                  Testimonials are assigned a status: <strong>APPROVED</strong>{" "}
                  (auto-approved), <strong>PENDING</strong> (needs review),{" "}
                  <strong>FLAGGED</strong> (suspicious), or{" "}
                  <strong>REJECTED</strong> (blocked).
                </p>
              </CardContent>
            </Card>
          )}
