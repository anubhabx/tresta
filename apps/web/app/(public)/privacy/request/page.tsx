                    ...
                    <CardContent className="pt-12 pb-12 text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground">
                                We've sent a magic link to the email you provided. Click the link to access your data management portal.
                            </p>
                        </div>

                        {magicLink && (
                            <div className="mt-6 p-4 bg-muted rounded border text-left overflow-hidden">
                                <p className="text-xs font-mono text-muted-foreground mb-2">[DEV ONLY] Magic Link:</p>
                                <a href={magicLink} className="text-sm text-primary break-all hover:underline">{magicLink}</a>
                            </div>
                        )}
            ...
            <Card className="max-w-lg w-full">
                <CardHeader className="text-center pb-8">
                    ...
                    <CardDescription className="text-base">
                        Enter your email to receive a secure link to access, download, or delete your personal data.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <p className="text-xs text-center text-muted-foreground pt-4">
                                By continuing, you agree to our <Link href="/privacy-policy" className="underline hover:text-foreground">Privacy Policy</Link>.
                            </p>
                        </form>
                    </Form>
                </CardContent>
