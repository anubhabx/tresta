      ...
      <div className="prose prose-zinc dark:prose-invert max-w-none">
        ...
        <div className="mt-8 space-y-6">
          <section>
            ...
            <p>
              You may cancel your subscription at any time. If you cancel, you
              will continue to have access to the Tresta service through the end
              of your current billing period. We do not provide refunds or
              credits for any partial-month subscription periods or unwatched
              content.
            </p>
            <p className="mt-2">
              To cancel your subscription, please go to your account settings
              page and follow the instructions for cancellation.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Subscriptions:</strong> Payments are non-refundable and
              there are no refunds or credits for partially used periods.
              Following any cancellation, however, you will continue to have
              access to the service through the end of your current billing
              period.
            </p>
            <p className="mt-2">
              ...
              same billing period, we will review the request and may issue a
