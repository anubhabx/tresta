 ...
 * - search: Search query for project name (prefix match)
 * - type: Filter by project type
 * - visibility: Filter by visibility (PUBLIC, PRIVATE, INVITE_ONLY)
 * - sortBy: Sort field (createdAt, name, testimonialCount)
 * - sortOrder: Sort order (asc, desc)
 * 
 * Returns:
 * - projects: Array of project objects with owner and testimonial counts
