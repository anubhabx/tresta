  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="p-10 group/file block rounded-lg cursor-pointer w-full relative overflow-hidden bg-stone-700/10"
      >
        <input
          ref={fileInputRef}
            ...
            {!files.length && (
              ...
              >
                {isDragActive ? (
                  ...
                  <IconUpload className="h-4 w-4 text-neutral-600 dark:text-primary" />
                )}
              </motion.div>
            )}
